...
* **Core Development:** The **vast majority** of the code and architectural design for this project was generated by **ChatGPT 4.0 (OpenAI)**.
* **Human Oversight:** The human developer acted as a director and quality control expert, providing **strategic input, design corrections, and necessary troubleshooting** to refine the AI-generated output into the final working application.
